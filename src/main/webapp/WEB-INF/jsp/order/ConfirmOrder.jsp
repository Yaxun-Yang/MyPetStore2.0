...
<table>
	...
	<img src='images/pay.jpg' id="pay" style='display:none;position:absolute; top:250px;left:700px;' width="240px" hight="350px">

	<a href="viewOrder" class="Button" onclick="reP()">Confirm</a>
